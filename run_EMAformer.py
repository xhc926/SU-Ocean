...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='EMAformer')

    # basic config
    parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
    parser.add_argument('--model', type=str, required=True, default='EMAformer',
                        help='model name, options: [EMAformer, iInformer, iReformer, iFlowformer, iFlashformer]')
