...
CHECKPOINTS="${CHECKPOINTS:-/root/autodl-tmp/simpletm/area2/checkpoints}"
LOG_DIR="${LOG_DIR:-/root/autodl-tmp/simpletm/area2/logs}"
RESULTS_DIR="${RESULTS_DIR:-/root/autodl-tmp/simpletm/area2/results}"
