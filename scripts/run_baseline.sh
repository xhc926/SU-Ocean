...
for SEQ_LEN in "${SEQ_LENS[@]}"; do
  ...
  for VAR in "${VARS[@]}"; do
    ...
    echo "=========================================="
    python -u run.py \
      --checkpoints /root/autodl-tmp/emaformer/area3/checkpoints/ \
      --log_dir /root/autodl-tmp/emaformer/area3/logs \
      --results_dir /root/autodl-tmp/emaformer/area3/results \
      --model $MODEL \
      --data $VAR \
