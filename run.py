...
data_parser = {
    ...
    'ALL3':{'data':'ALL3.pkl','T':'target','M':[637,637,637],'S':[1,1,1],'MS':[637,637,1], 'root':'/root/autodl-tmp/data/upsampled/1-12/area3/short'},
    'ALL4':{'data':'ALL4.pkl','T':'target','M':[637,637,637],'S':[1,1,1],'MS':[637,637,1], 'root':'/root/autodl-tmp/data/upsampled/1-12/area3'},
    ...
    'sal_1_12':{'data':'sal.pkl','T':'target','M':[637,637,637],'S':[1,1,1],'MS':[637,637,637], 'root':'/root/autodl-tmp/data/upsampled/1-12/area3'},
    'sst_1_12':{'data':'sst.pkl','T':'target','M':[637,637,637],'S':[1,1,1],'MS':[637,637,637], 'root':'/root/autodl-tmp/data/upsampled/1-12/area3/short'},
